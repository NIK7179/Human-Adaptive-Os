...
public struct AdaptiveScoringConfiguration: Sendable {
    ...
    public static let production = AdaptiveScoringConfiguration(
        ...
        usefulAges: [
            .positiveValence: 4 * 60 * 60.0,
            .negativeValence: 4 * 60 * 60.0,
            .reportedStress: 4 * 60 * 60.0,
            .reportedCalm: 4 * 60 * 60.0,
            .lowEnergy: 4 * 60 * 60.0,
            .highEnergy: 4 * 60 * 60.0,
            .interactionFatigue: 30 * 60.0,
            .prolongedSession: 30 * 60.0,
            .rapidNavigation: 30 * 60.0,
            .rainyWeather: 60 * 60.0,
            .pleasantWeather: 60 * 60.0,
            .highUV: 60 * 60.0,
            .poorSleep: 24 * 60 * 60.0,
            .goodSleep: 24 * 60 * 60.0,
            .thermalPressure: 5 * 60.0,
            .lateNight: 60 * 60.0,
            .earlyMorning: 60 * 60.0,
            .daytime: 3 * 60 * 60.0,
            .solarBrightness: 60 * 60.0,
            .outdoorLikelihood: 30 * 60.0,
            .highAmbientVisibility: 30 * 60.0,
            .lowAmbientVisibility: 30 * 60.0,
            .upcomingInterview: 3 * 60 * 60.0,
            .activeFocusGoal: 3 * 60 * 60.0,
            .physicalActivity: 2 * 60 * 60.0,
            .inactivity: 2 * 60 * 60.0,
            .lowPowerMode: 5 * 60.0,
            .reducedMotionPreference: 24 * 60 * 60.0,
            .increasedContrastPreference: 24 * 60 * 60.0,
            .largeTextPreference: 24 * 60 * 60.0,
            .manualModeRequest: 60 * 60.0,
        ]
    )
}
